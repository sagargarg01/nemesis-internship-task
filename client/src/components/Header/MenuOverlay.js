    ...
    return (
      <div className={classes.root}>
        <div className='overlayUserImg'>
          <img
            src='https://res.cloudinary.com/djgvt8uo4/image/upload/v1621674024/users/user_vprxe7.png'
            alt='image'
          />
        </div>
        <div className='overlayUserInfo'>
          <div className='overlayUserName'>admin</div>
